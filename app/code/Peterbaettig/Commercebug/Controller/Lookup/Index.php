...
* All rights reserved
*/
namespace Peterbaettig\Commercebug\Controller\Lookup;
use ReflectionClass;

class Index extends \Peterbaettig\Commercebug\Controller\AbstractController
{    
    ...
    protected function getClassFromManager($class)
    {
        ...
        {       
            ...
            if($om_class)
            {
                $class_from_manager = get_class($om_class);
            }
        }            
