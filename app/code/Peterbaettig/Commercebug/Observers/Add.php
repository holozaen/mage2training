...
class Add extends AbstractObserver
{
    ...
    public function __construct(
        ...
        \Peterbaettig\Commercebug\Model\LogFactory $logFactory,
        \Peterbaettig\Commercebug\Model\RenderedData $renderedData,        
        \Magento\Developer\Helper\Data $developerHelper,
        \Peterbaettig\Commercebug\Renderer\JsonFactory $jsonFactory,
    ...
    protected function getCommerceBugData($observer)
    {
        ...
        $cb_data = \Peterbaettig\Commercebug\Model\All::asData();
